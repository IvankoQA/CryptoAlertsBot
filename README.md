...
### Способ 1: Быстрый деплой
```bash
npm run deploy
```

### Способ 2: Автоматический деплой при изменениях
```bash
...
**Или используйте автоматический деплой через GitHub Actions (настраивается в Railway Dashboard)**
